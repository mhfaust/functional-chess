import { rank, file, isOnBoard, playerAt, isOccupied, areSamePositions }
    from 'position-utils/index';

function canRookMove (board: Board, fromPosition: GridCoordinates, toPosition: GridCoordinates)
    : boolean {
