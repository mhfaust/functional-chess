System.register(["constants/move-vectors", "board-utils/pieces-shorthand"], function (exports_1, context_1) {
    "use strict";
    var move_vectors_1, pieces_shorthand_1, knight, bishop, whiteAttackPatterns, blackAttackPatterns;
    ...
    return {
        ...
        execute: function () {
            knight = {
                vectors: move_vectors_1.knightVectors,
                limit: 1,
                canMoveLikeThis: new Set([pieces_shorthand_1.WN])
            };
            bishop = {
                vectors: move_vectors_1.bishopVectors,
                limit: 0,
                canMoveLikeThis: new Set([pieces_shorthand_1.WN])
            };
