System.register(["positions/allPlayerPositions", "board"], function (exports_1, context_1) {
    "use strict";
    var allPlayerPositions_1, board_1;
    ...
    return {
        ...
        execute: function () {
            describe('allPlayerPositions finds all white piecesonr initial board', function () {
                var results = allPlayerPositions_1.default(board_1.initialBoard(), "White");
            ...
            describe('allPlayerPositions finds all white piecesonr initial board', function () {
                var results = allPlayerPositions_1.default(board_1.initialBoard(), "Black");
