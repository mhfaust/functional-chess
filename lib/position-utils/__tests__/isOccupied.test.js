System.register(["position-utils/isOccupied", "board-utils/index", "constants/algebraic"], function (exports_1, context_1) {
    "use strict";
        ...
        execute: function () {
            describe('isOccupied', function () {
                it('reports true for initially positioned rook', function () {
                    expect(isOccupied_1["default"](index_1.initialBoard(), algebraic_1.Position.A1)).toBe(true);
                });
                it('reports false for empty square', function () {
                    expect(isOccupied_1["default"](index_1.initialBoard(), algebraic_1.Position.A3)).toBe(false);
                });
            });
        }
    };
