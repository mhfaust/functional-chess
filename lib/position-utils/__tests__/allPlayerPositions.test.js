System.register(["../allPlayerPositions", "boards/index", "constants/pieces", "constants/algebraic", "../algebraicName"], function (exports_1, context_1) {
    "use strict";
    var allPlayerPositions_1, index_1, pieces_1, algebraic_1, algebraicName_1, White, WK, WQ, WR, WN, WB, WP, __;
    ...
    return {
        ...
        execute: function () {
            White = pieces_1.Player.White;
            WK = pieces_1.Piece.WK, WQ = pieces_1.Piece.WQ, WR = pieces_1.Piece.WR, WN = pieces_1.Piece.WN, WB = pieces_1.Piece.WB, WP = pieces_1.Piece.WP, __ = pieces_1.Piece.__;
