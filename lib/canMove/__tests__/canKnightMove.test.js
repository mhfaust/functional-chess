System.register(["canMove/canKnightMove", "boards/index", "constants/algebraic"], function (exports_1, context_1) {
    "use strict";
        ...
        execute: function () {
            describe('canKnightMove', function () {
                it('reports true attempting to move to empty square, 2 forward, 1 left.', function () {
                    var answer = canKnightMove_1["default"](index_1.initialBoard(), algebraic_1.B1, algebraic_1.A3);
                    expect(answer).toBe(true);
                });
                it('reports true attempting to move to empty square, 2 forward, 1 right.', function () {
                    var answer = canKnightMove_1["default"](index_1.initialBoard(), algebraic_1.B1, algebraic_1.C3);
                    expect(answer).toBe(true);
                });
                it('reports false attempting to move to square occupied by own players piece.', function () {
                    var answer = canKnightMove_1["default"](index_1.initialBoard(), algebraic_1.B1, algebraic_1.C2);
                    expect(answer).toBe(false);
                });
                it('reports false attempting to move to mechanically disallowed square', function () {
                    var answer = canKnightMove_1["default"](index_1.initialBoard(), algebraic_1.B1, algebraic_1.B4);
                    expect(answer).toBe(false);
                });
                it('reports false attempting to move off-board', function () {
                    var answer = canKnightMove_1["default"](index_1.initialBoard(), algebraic_1.B1, [-1, 1]);
                    expect(answer).toBe(false);
                });
            });
        }
