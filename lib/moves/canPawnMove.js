System.register(["position-utils/index", "check/movesIntoCheck"], function (exports_1, context_1) {
    ...
    function canPawnMove(board, fromPosition, toPosition, kingPosition, passantInfo) {
        ...
        if (stepsSideways === 0) {
            ...
            if (index_1.isUnOccupied(board, toPosition) && (!passantInfo || !index_1.areSamePositions(toPosition, passantInfo.passedPosition))) {
                return false;
            }
        ...
        if (movesIntoCheck_1["default"](board, fromPosition, toPosition, kingPosition)) {
