System.register(["moves/nextBoard", "position-utils/index", "check/index", "constants/position"], function (exports_1, context_1) {
    "use strict";
    ...
    var nextBoard_1, index_1, index_2, position_1, makePassantInfo, makeCapturedPieces;
    ...
    function nextAnnotatedBoard(previous, pieceMovedFromPosition, pieceMovedToPosition) {
        ...
        var next = {
            ...
            CastlingPreclusions: {
                Black: {
                    kingSide: previous.CastlingPreclusions.Black.kingSide || movedFrom(position_1.Position.F8) || movedFrom(position_1.Position.H8),
                    queenSide: previous.CastlingPreclusions.Black.queenSide || movedFrom(position_1.Position.F8) || movedFrom(position_1.Position.A8)
                },
                White: {
                    kingSide: previous.CastlingPreclusions.White.kingSide || movedFrom(position_1.Position.F1) || movedFrom(position_1.Position.H1),
                    queenSide: previous.CastlingPreclusions.White.queenSide || movedFrom(position_1.Position.F1) || movedFrom(position_1.Position.A1)
                }
            },
            capturedPieces: {
