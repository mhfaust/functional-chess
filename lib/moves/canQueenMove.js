System.register(["./canRookMove", "moves/canBishopMove"], function (exports_1, context_1) {
    ...
    function queenCanMove(board, fromPosition, toPosition, kingPosition) {
        return canRookMove_1["default"](board, fromPosition, toPosition, kingPosition)
            || canBishopMove_1["default"](board, fromPosition, toPosition, kingPosition);
    }
    return {
        setters: [
