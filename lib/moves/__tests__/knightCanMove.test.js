System.register(["moves/knightCanMove", "board-utils/index", "constants/position", "board-utils/pieces-shorthand", "board-utils/kingPositions"], function (exports_1, context_1) {
    "use strict";
    var knightCanMove_1, index_1, position_1, pieces_shorthand_1, kingPositions_1;
    ...
    return {
        ...
        execute: function () {
            describe('knightCanMove', function () {
                var initialAnnotations = kingPositions_1["default"](index_1.initialBoard());
                it('reports true attempting to move to empty square, 2 forward, 1 left.', function () {
                    var answer = knightCanMove_1["default"](index_1.initialBoard(), position_1.Position.B1, position_1.Position.A3, initialAnnotations);
                    expect(answer).toBe(true);
                });
                it('reports true attempting to move to empty square, 2 forward, 1 right.', function () {
                    var answer = knightCanMove_1["default"](index_1.initialBoard(), position_1.Position.B1, position_1.Position.C3, initialAnnotations);
                    expect(answer).toBe(true);
                });
                it('reports false attempting to move to square occupied by own players piece.', function () {
                    var answer = knightCanMove_1["default"](index_1.initialBoard(), position_1.Position.B1, position_1.Position.C2, initialAnnotations);
                    expect(answer).toBe(false);
                });
                it('reports false attempting to move to mechanically disallowed square', function () {
                    var answer = knightCanMove_1["default"](index_1.initialBoard(), position_1.Position.B1, position_1.Position.B4, initialAnnotations);
                    expect(answer).toBe(false);
                });
                it('reports false attempting to move off-board', function () {
                    var answer = knightCanMove_1["default"](index_1.initialBoard(), position_1.Position.B1, [-1, 1], initialAnnotations);
                    expect(answer).toBe(false);
                });
