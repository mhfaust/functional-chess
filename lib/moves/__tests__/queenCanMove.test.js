System.register(["moves/queenCanMove", "board-utils/pieces-shorthand", "constants/position", "board-utils/index"], function (exports_1, context_1) {
    "use strict";
    var queenCanMove_1, pieces_shorthand_1, position_1, index_1;
        ...
        execute: function () {
            describe('queenCanMove', function () {
                ...
                it('can move right one', function () {
                    expect(queenCanMove_1["default"](queen1Board, position_1.Position.C2, position_1.Position.C3, index_1.kingPositions(queen1Board))).toBe(true);
                });
                it('cannot take own piece', function () {
                    expect(queenCanMove_1["default"](queen1Board, position_1.Position.C2, position_1.Position.C4, index_1.kingPositions(queen1Board))).toBe(false);
                });
                it('can capture opponent piece, diagonally', function () {
                    expect(queenCanMove_1["default"](queen1Board, position_1.Position.C2, position_1.Position.F5, index_1.kingPositions(queen1Board))).toBe(true);
                });
            });
        }
    };
