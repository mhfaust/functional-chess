System.register(["moves/canPawnMove", "board-utils/pieces-shorthand", "constants/position"], function (exports_1, context_1) {
    "use strict";
    var canPawnMove_1, pieces_shorthand_1, position_1, pawn1Board;
            ...
            describe('canPawnMove', function () {
                describe('white', function () {
                    it('can move one space forward when NOT blocked', function () {
                        var answer = canPawnMove_1["default"](pawn1Board(), position_1.Position.C3, position_1.Position.C4, position_1.Position.E1, null);
                        expect(answer).toBe(true);
                    });
                    it('cannot move one space forward when IS blocked', function () {
                        var answer = canPawnMove_1["default"](pawn1Board(), position_1.Position.H4, position_1.Position.H5, position_1.Position.E1, null);
                        expect(answer).toBe(false);
                    });
                    it('can capture forward right', function () {
                        var answer = canPawnMove_1["default"](pawn1Board(), position_1.Position.D4, position_1.Position.E5, position_1.Position.E1, null);
                        expect(answer).toBe(true);
                    });
                    it('can capture forward left', function () {
                        var answer = canPawnMove_1["default"](pawn1Board(), position_1.Position.C3, position_1.Position.B4, position_1.Position.E1, null);
                        expect(answer).toBe(true);
                    });
                    it('cannot move foward left to empty square', function () {
                        var answer = canPawnMove_1["default"](pawn1Board(), position_1.Position.G2, position_1.Position.F3, position_1.Position.E1, null);
                        expect(answer).toBe(false);
                    });
                    it('cannot move foward right to empty square', function () {
                        var answer = canPawnMove_1["default"](pawn1Board(), position_1.Position.E2, position_1.Position.F3, position_1.Position.E1, null);
                        expect(answer).toBe(false);
                    });
                    it('cannot move backward', function () {
                        var answer = canPawnMove_1["default"](pawn1Board(), position_1.Position.G5, position_1.Position.H5, position_1.Position.E1, null);
                        expect(answer).toBe(false);
                    });
                    it('cannot move sideways', function () {
                        var answer = canPawnMove_1["default"](pawn1Board(), position_1.Position.H4, position_1.Position.G4, position_1.Position.E1, null);
                        expect(answer).toBe(false);
                    });
                });
                describe('black', function () {
                    it('can move one space forward when NOT blocked', function () {
                        var answer = canPawnMove_1["default"](pawn1Board(), position_1.Position.E5, position_1.Position.E4, position_1.Position.E8, null);
                        expect(answer).toBe(true);
                    });
                    it('can move one space forward when IS blocked', function () {
                        var answer = canPawnMove_1["default"](pawn1Board(), position_1.Position.D5, position_1.Position.D4, position_1.Position.E8, null);
                        expect(answer).toBe(false);
                    });
                    it('can capture forward right', function () {
                        var answer = canPawnMove_1["default"](pawn1Board(), position_1.Position.E5, position_1.Position.D4, position_1.Position.E8, null);
                        expect(answer).toBe(true);
                    });
                    it('can capture forward left', function () {
                        var answer = canPawnMove_1["default"](pawn1Board(), position_1.Position.G5, position_1.Position.H4, position_1.Position.E8, null);
                        expect(answer).toBe(true);
                    });
                    it('cannot move backward', function () {
                        var answer = canPawnMove_1["default"](pawn1Board(), position_1.Position.B4, position_1.Position.B5, position_1.Position.E8, null);
                        expect(answer).toBe(false);
                    });
                    it('cannot move sideways', function () {
                        var answer = canPawnMove_1["default"](pawn1Board(), position_1.Position.H4, position_1.Position.G4, position_1.Position.E8, null);
                        expect(answer).toBe(false);
                    });
                });
                describe('en-passant rule', function () {
                    ...
                    it('black pawn can attack a square passed by a white pawn moving from rank 2 to 4', function () {
                        ...
                        var answer = canPawnMove_1["default"](board, position_1.Position.D4, position_1.Position.E3, position_1.Position.E8, passantInfo);
                        expect(answer).toBe(true);
                    });
                    it('black pawn cannot attack a passant-looking square if passant info is null', function () {
                        var answerNullPassantInfo = canPawnMove_1["default"](board, position_1.Position.D4, position_1.Position.E3, position_1.Position.E8, null);
                        expect(answerNullPassantInfo).toBe(false);
                    });
                    fit('white pawn can attack a square passed by a black pawn moving from rank 2 to 4', function () {
                        var passantInfo = {
                            passedPosition: position_1.Position.G6,
                            pawnAt: position_1.Position.G5
                        };
                        var answer = canPawnMove_1["default"](board, position_1.Position.H5, position_1.Position.G6, position_1.Position.E8, passantInfo);
                        expect(answer).toBe(true);
                    });
                    it('white pawn cannot attack a passant-looking square if passant info is null', function () {
                        var answerNullPassantInfo = canPawnMove_1["default"](board, position_1.Position.H5, position_1.Position.G6, position_1.Position.E8, null);
                        expect(answerNullPassantInfo).toBe(false);
                    });
                });
            });
