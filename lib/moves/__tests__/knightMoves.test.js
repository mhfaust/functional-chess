System.register(["moves/knightMoves", "board-utils/index", "constants/position"], function (exports_1, context_1) {
    "use strict";
    var knightMoves_1, index_1, position_1;
        ...
        execute: function () {
            describe('knight', function () {
                it('can move from initial board white queen knight to A3 and C3 only', function () {
                    var attackedPositions = knightMoves_1["default"](index_1.initialBoard(), position_1.Position.B1, position_1.Position.E1);
                ...
                it('can move from initial board white king knight to A3 and C3 only', function () {
                    var attackedPositions = knightMoves_1["default"](index_1.initialBoard(), position_1.Position.G1, position_1.Position.E1);
                ...
                it('can move from initial board black queen knight to A3 and C3 only', function () {
                    var attackedPositions = knightMoves_1["default"](index_1.initialBoard(), position_1.Position.B8, position_1.Position.E8);
                ...
                it('can move from initial board black king knight to A3 and C3 only', function () {
                    var attackedPositions = knightMoves_1["default"](index_1.initialBoard(), position_1.Position.G8, position_1.Position.E8);
