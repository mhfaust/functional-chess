System.register(["moves/knightMoves", "board", "constants/position", "positions/pieces-shorthand", "board/kingPositions"], function (exports_1, context_1) {
    "use strict";
    var knightMoves_1, board_1, position_1, pieces_shorthand_1, kingPositions_1;
        ...
        execute: function () {
            describe('knight', function () {
                it('can move from initial board white queen knight to A3 and C3 only', function () {
                    var legalMoves = knightMoves_1.default(board_1.initialBoard(), position_1.Position.B1, kingPositions_1.default(board_1.initialBoard()));
                ...
                it('can move from initial board white king knight to A3 and C3 only', function () {
                    var legalMoves = knightMoves_1.default(board_1.initialBoard(), position_1.Position.G1, kingPositions_1.default(board_1.initialBoard()));
                ...
                it('can move from initial board black queen knight to A3 and C3 only', function () {
                    var legalMoves = knightMoves_1.default(board_1.initialBoard(), position_1.Position.B8, kingPositions_1.default(board_1.initialBoard()));
                ...
                it('can move from initial board black king knight to A3 and C3 only', function () {
                    var legalMoves = knightMoves_1.default(board_1.initialBoard(), position_1.Position.G8, kingPositions_1.default(board_1.initialBoard()));
