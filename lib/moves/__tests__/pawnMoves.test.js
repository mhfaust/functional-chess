System.register(["../pawnMoves", "position-utils/index", "constants/position", "board-utils/pieces-shorthand"], function (exports_1, context_1) {
    "use strict";
    var pawnMoves_1, index_1, position_1, pieces_shorthand_1, pawn1Board, pawn1boardAnnotations;
    ...
    return {
        ...
        execute: function () {
            ...
            pawn1boardAnnotations = {
                blackKingPosition: index_1.locatePiece(pawn1Board, "Black King"),
                whiteKingPosition: index_1.locatePiece(pawn1Board, "White King"),
                pawnAt: null,
                passedPosition: null
            };
