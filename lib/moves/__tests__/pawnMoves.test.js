        ...
        execute: function () {
            ...
            describe('pawn', function () {
                ...
                testCases.forEach(function (testCase) {
                    it("provides all possible moves from pawn at " + index_1.algebraicName(testCase.pawnPosition) + " on pawn1board: ", function () {
                        ...
                        var foundMoves = pawnMoves_1["default"](board, testCase.pawnPosition);
                        expect(foundMoves).toEqual(new Set(testCase.attackedPositions.map(index_1.algebraicName)));
                    });
                });
            });
            describe('en passant', function () {
                ...
                it('black pawn can attack a square passed by a white pawn moving from rank 2 to 4', function () {
                    ...
                    var foundMoves = pawnMoves_1["default"](board, algebraic_1.Position.D4, passantInfo);
                    expect(foundMoves).toContain(index_1.algebraicName(algebraic_1.Position.E3));
                });
                it('black pawn cannot attack a passant-looking square if passant info is null', function () {
                    var foundMoves = pawnMoves_1["default"](board, algebraic_1.Position.D4, null);
                    expect(foundMoves).not.toContain(index_1.algebraicName(algebraic_1.Position.E3));
                });
                it('white pawn can attack a square passed by a black pawn moving from rank 2 to 4', function () {
                    ...
                    var foundMoves = pawnMoves_1["default"](board, algebraic_1.Position.H5, passantInfo);
                    expect(foundMoves).toContain(index_1.algebraicName(algebraic_1.Position.G6));
                });
                it('white pawn cannot attack a passant-looking square if passant info is null', function () {
                    var foundMoves = pawnMoves_1["default"](board, algebraic_1.Position.H5, null);
                    expect(foundMoves).not.toContain(index_1.algebraicName(algebraic_1.Position.G6));
                });
            });
        }
    };
