System.register(["../queenMoves", "positions", "constants/position", "positions/pieces-shorthand", "board"], function (exports_1, context_1) {
    "use strict";
    var queenMoves_1, positions_1, position_1, pieces_shorthand_1, board_1;
        ...
        execute: function () {
            describe('queen', function () {
                it("provides all possible moves from queen on queen1board: ", function () {
                    ...
                    var foundattackedPositions = queenMoves_1.default(board, position_1.Position.C2, board_1.kingPositions(board));
                ...
                it('does not include moves putting self in check', function () {
                    ...
                    var foundLegalMoves = queenMoves_1.default(board, position_1.Position.E4, board_1.kingPositions(board));
