        ...
        execute: function () {
            describe('queen', function () {
                it("provides all possible moves from queen on queen1board: ", function () {
                    ...
                    var foundattackedPositions = queenMoves_1["default"](board, position_1.Position.C2, annotations);
                ...
                it('does not include moves putting self in check', function () {
                    ...
                    var foundLegalMoves = queenMoves_1["default"](board, position_1.Position.E4, annotations);
