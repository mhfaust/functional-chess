System.register(["../bishopMoves", "position-utils/index", "constants/algebraic", "board-utils/pieces-shorthand"], function (exports_1, context_1) {
    "use strict";
    var bishopMoves_1, index_1, algebraic_1, pieces_shorthand_1;
        ...
        execute: function () {
            describe('bishop', function () {
                it("provides all possible moves from bishop ", function () {
                    ...
                    var foundattackedPositions = bishopMoves_1["default"](board, algebraic_1.Position.D4, algebraic_1.Position.E1);
                ...
                it('does not include moves putting self in check', function () {
                    ...
                    var foundattackedPositions = bishopMoves_1["default"](board, algebraic_1.Position.D4, algebraic_1.Position.A1);
                    expect(foundattackedPositions).toEqual(expectedattackedPositions);
                });
            });
        }
