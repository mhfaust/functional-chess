System.register(["constants/position", "board-utils/pieces-shorthand", "moves/canMove", "board-utils/kingPositions"], function (exports_1, context_1) {
    "use strict";
    ...
    var position_1, pieces_shorthand_1, canMove_1, kingPositions_1;
        ...
        execute: function () {
            describe('canMove Bishop', function () {
                it('Can move bishop only along axis of potential check while blocking check', function () {
                    ...
                    var annotations = kingPositions_1["default"](board);
            ...
            describe('canMove Queen', function () {
                ...
                it('can capture opponent piece, diagonally', function () {
                    expect(canMove_1["default"](board, position_1.Position.C2, position_1.Position.F5, kingPositions_1["default"](board))).toBe(true);
                });
            });
