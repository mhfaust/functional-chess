        ...
        execute: function () {
            ...
            describe('kingMoves', function () {
                it('Cannot move, initially', function () {
                    ...
                    var foundLegalMoves = moves_1.kingMoves(board, position_1.Position.E1, boardAnnotations);
                ...
                it('King moves any diection, only one square', function () {
                    ...
                    var foundLegalMoves = moves_1.kingMoves(board, position_1.Position.D7, boardAnnotations);
                    expect(foundLegalMoves).toEqual(expectedLegalMoves);
                });
                ...
                it('Black king can castle, queen-side', function () {
                    ...
                    var boardAnnotations = __assign({}, noPreclusions, kingPositions_1.default(board));
                    var foundLegalMoves = moves_1.kingMoves(board, position_1.Position.E8, boardAnnotations);
