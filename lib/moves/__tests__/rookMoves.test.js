System.register(["../rookMoves", "constants/position", "board-utils/pieces-shorthand"], function (exports_1, context_1) {
    "use strict";
    var rookMoves_1, position_1, pieces_shorthand_1;
        ...
        execute: function () {
            describe('rook', function () {
                it("provides all possible moves from rook on rook1board: ", function () {
                    ...
                    var foundLegalMoves = rookMoves_1["default"](board, position_1.Position.E4, position_1.Position.E8);
