System.register(["position-utils/index", "constants/attackPatterns"], function (exports_1, context_1) {
    ...
    function generateLinesOfAttack(board, defender, defendedPosition) {
        var e_1, _a, e_2, _b, attacker, attackPatterns, defendedPiece, assessingCheck, attackLines, attackPatterns_2, attackPatterns_2_1, attackPattern, canMoveLikeThis, vectors, limit, vectors_1, vectors_1_1, vector, attackLine, examinedPosition, step, pieceThere, e_2_1, e_1_1;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    assessingCheck = defendedPiece === "White King" || defendedPiece === "Black King";
                    attackLines = new Map();
                    _c.label = 1;
                case 1:
                ...
                case 5:
                    ...
                    if (!(index_1.playerAt(board, examinedPosition) === attacker
                        ...
                        && !attackLines.has(index_1.algebraicName(examinedPosition)))) return [3, 7];
                    return [4, attackLine];
                case 6:
                    _c.sent();
