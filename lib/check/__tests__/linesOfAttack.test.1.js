        ...
        execute: function () {
            ...
            describe('linesOfAttack', function () {
                it('finds the line from a bishop at C3 to E5', function () {
                    ...
                    expect(linesOfAttack_1["default"](board, pieces_1.Player.White, algebraic_1.Position.E5))
                        .toEqual([
                ...
                it('finds several lines of attack', function () {
                    ...
                    var lines = linesOfAttack_1["default"](board, pieces_1.Player.Black, algebraic_1.Position.F3);
...
//# sourceMappingURL=linesOfAttack.test.1.js.map