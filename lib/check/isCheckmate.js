System.register(["moves/index", "check/index", "position-utils/index", "constants/move-vectors", "check/isInCheck"], function (exports_1, context_1) {
    "use strict";
    ...
    var index_1, index_2, index_3, move_vectors_1, isInCheck_1;
    ...
    function isCheckmate(board, defender, kingPosition) {
        ...
        var kingPiece = defender === "Black" ? "Black King" : "White King";
        try {
