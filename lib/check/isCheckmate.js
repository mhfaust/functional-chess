System.register(["check/index", "position-utils/index", "constants/move-vectors", "check/movesIntoCheck"], function (exports_1, context_1) {
    "use strict";
    ...
    var index_1, index_2, move_vectors_1, movesIntoCheck_1;
    ...
    function isCheckmate(board, defender, boardAnnotations) {
        ...
        for (var i = 0; i < move_vectors_1.kingVectors.length; i++) {
            ...
            if (index_2.isOnBoard(kingMovesTo) && index_2.playerAt(board, kingMovesTo) !== defender) {
                if (!movesIntoCheck_1["default"](board, kingPosition, kingMovesTo, boardAnnotations)) {
                    return false;
                }
            }
        }
        ...
        try {
            for (var _b = __values(checkLine.value), _c = _b.next(); !_c.done; _c = _b.next()) {
                ...
                while (!defensiveMoveInfo.done) {
                    ...
                    if (!movesIntoCheck_1["default"](board, defendingPieceMovesFrom, positionOnCheckLine, boardAnnotations)) {
                        return false;
                    }
