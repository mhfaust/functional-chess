System.register(["board/index", "check/index", "positions/index"], function (exports_1, context_1) {
    "use strict";
    ...
    function movesIntoCheck(board, moveFrom, moveTo, annotations) {
        ...
        var updatedAnnotations = index_1.nextKingAnnotations(board, moveFrom, moveTo, annotations);
